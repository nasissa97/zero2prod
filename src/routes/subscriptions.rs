...
use crate::startup::AppliactionBaseUrl;
...
pub async fn subscribe(
    ...
    base_url: web::Data<AppliactionBaseUrl>,
) -> HttpResponse {
    ...
    let subscriber_id = match insert_subsciber(&mut transaction, &new_subscriber).await {
